        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            */
            ...
            client.println("<form action=\"http://192.168.137.81\" method=\"get\">");
            client.println("<input type=\"hidden\" name=\"value\" value=\"On%\"><br>");
            client.println("<button type=\"submit\">On</button>");
            client.println("</form>");
            //Button to turn off red led
            client.println("<form action=\"http://192.168.137.81\" method=\"get\">");
            client.println("<input type=\"hidden\" name=\"value\" value=\"Off%\"><br>");
